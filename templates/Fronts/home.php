...
<!-- Mirrored from demo.themeies.com/roysha-html/home-01.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Oct 2020 09:53:22 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
                  ...
                  <form class="" action="#">
                    ...
                    <div class="form-field">
                      ...
                      <div class="join-field">
                        <input type="text" name="send_amount" placeholder="$1,000.00">
                        <div class="curr-select">
                          <span class="selected"><img src="images/flags/australia.png" alt="">aud &nbsp;<i class="fas fa-caret-down"></i></span>
                          <ul>
                            <li><a href="#"><img src="images/flags/australia.png" alt="">aud</a></li>
                            <li><a href="#"><img src="images/flags/usa.png" alt="">usa</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
    ...
    <section class="payment-service bg-offwhite">
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6">
            <figure class="imgBox">
              <img src="images/payment-service.png" alt="">
            </figure>
          </div>
        </div>
      </div>
...
<!-- Mirrored from demo.themeies.com/roysha-html/home-01.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 16 Oct 2020 09:53:37 GMT -->
</html>