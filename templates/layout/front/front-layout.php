...
<head>
    ...
    <title>Zippy Transfer - A Fast And Better Way To Send Money</title>
  </head>
  <body class="home-one">
    ...
    <header class="header04">
      <div class="container d-flex align-items-center">
          ...
          <a href="login.html" class="login btn-default"><span class="bh"></span> <span>Register</span></a>
          <a href="login.html"><span class="bh"></span> <span>Register</span></a>
      </div>
    </header>
    <!-- Header end -->
          ...
          <div class="col-lg-5 col-md-12">
            <div class="form-tab">
              <ul class="nav nav-tabs">
                <li><a class="active" data-toggle="tab" href="#send-money">Send Money</a></li>
                  ...
                  <form class="" action="#">
                    <div class="form-field">
                      ...
                      <div class="join-field">
                        ...
                        <div class="curr-select">
                          <span class="selected"><img src="/assets/images/flags/usa.png" alt="">usd &nbsp;<i class="fas fa-caret-down"></i></span>
                          <ul>
                            <li><a href="#"><img src="/assets/images/flags/australia.png" alt="">aud</a></li>
                            <li><a href="#"><img src="/assets/images/flags/canada.png" alt="">cad</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-field">
                      ...
                      <div class="join-field">
                        <input type="text" name="send_amount" placeholder="$1,000.00">
                        <div class="curr-select">
                          <span class="selected"><img src="/assets/images/flags/australia.png" alt="">aud &nbsp;<i class="fas fa-caret-down"></i></span>
                          <ul>
                            <li><a href="#"><img src="/assets/images/flags/australia.png" alt="">aud</a></li>
                            <li><a href="#"><img src="/assets/images/flags/usa.png" alt="">usa</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
        ...
        <div class="row align-items-center">
          <div class="col-md-6">
            <div class="content-box">
              ...
              <a href="#" class="btn btn-default"><span class="bh"></span> <span>try it now</span></a>
            </div>
          </div>
          <div class="col-md-6">
            <figure class="imgBox">
              <img src="/assets/images/payment-service.png" alt="">
            </figure>
          </div>
        </div>
      </div>
        ...
        <div class="row align-items-center">
          <div class="col-md-6">
            <div class="content-box-fluid right">
              ...
              <a href="#" class="btn btn-default"><span class="bh"></span> <span>Learn More</span></a>
            </div>
          </div>
          <div class="col-md-6">
            <figure class="video-box"> 
              <img src="images/video-bg/1.jpg" alt="">
          ...
          <div class="col-lg-10 col-md-12 m-auto">
            <div class="testimonialBox">
              ...
              <div class="client-thumb owl-thumbs" data-slider-id="1">
                <a href="javascript:void(0)" class="owl-thumb-item"><img src="images/avatar.png" alt=""></a>
                <a href="javascript:void(0)" class="owl-thumb-item"><img src="images/avatar.png" alt=""></a>
                <a href="javascript:void(0)" class="owl-thumb-item"><img src="images/avatar.png" alt=""></a>
              </div>
            </div>            
